...
{
    vnn_ReleaseYolo26s6Pcq( graph, TRUE );
...
{
    return vnn_PostProcessYolo26s6Pcq( graph );
}
    ...
    )
{
    ...
    return vnn_PreProcessYolo26s6Pcq( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateYolo26s6Pcq( data_file_name, NULL,

...
{
    vnn_ReleaseYolo26x6Pcq( graph, TRUE );
...
{
    return vnn_PostProcessYolo26x6Pcq( graph );
}
    ...
    )
{
    ...
    return vnn_PreProcessYolo26x6Pcq( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateYolo26x6Pcq( data_file_name, NULL,

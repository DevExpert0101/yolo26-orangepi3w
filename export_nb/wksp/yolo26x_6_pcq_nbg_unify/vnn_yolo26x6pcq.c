...
vsi_nn_graph_t * vnn_CreateYolo26x6Pcq
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.05561603605747223;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.06027591973543167;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.05560006573796272;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.10521765053272247;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.11606687307357788;
    attr.dtype.zero_point = 127;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.146205872297287;
...
error:
    ...
    vnn_ReleaseYolo26x6Pcq( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateYolo26x6Pcq() */

void vnn_ReleaseYolo26x6Pcq
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )

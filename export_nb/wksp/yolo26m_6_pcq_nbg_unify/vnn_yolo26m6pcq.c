...
vsi_nn_graph_t * vnn_CreateYolo26m6Pcq
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.04878450557589531;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.07758773863315582;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.056704454123973846;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.11093804985284805;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.1353914439678192;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.1976049393415451;
...
error:
    ...
    vnn_ReleaseYolo26m6Pcq( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateYolo26m6Pcq() */

void vnn_ReleaseYolo26m6Pcq
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )

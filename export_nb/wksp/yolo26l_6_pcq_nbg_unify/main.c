...
{
    vnn_ReleaseYolo26l6Pcq( graph, TRUE );
...
{
    return vnn_PostProcessYolo26l6Pcq( graph );
}
    ...
    )
{
    ...
    return vnn_PreProcessYolo26l6Pcq( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateYolo26l6Pcq( data_file_name, NULL,

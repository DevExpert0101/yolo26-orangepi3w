...
vsi_nn_graph_t * vnn_CreateYolo26l6Pcq
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.05289314314723015;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.0622345432639122;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.054280538111925125;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.12214461714029312;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.1298629492521286;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.16756965219974518;
...
error:
    ...
    vnn_ReleaseYolo26l6Pcq( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateYolo26l6Pcq() */

void vnn_ReleaseYolo26l6Pcq
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )

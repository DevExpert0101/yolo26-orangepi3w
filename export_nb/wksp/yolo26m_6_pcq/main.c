...
{
    vnn_ReleaseYolo26m6Pcq( graph, TRUE );
...
{
    return vnn_PostProcessYolo26m6Pcq( graph );
}
    ...
    )
{
    ...
    return vnn_PreProcessYolo26m6Pcq( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateYolo26m6Pcq( data_file_name, NULL,

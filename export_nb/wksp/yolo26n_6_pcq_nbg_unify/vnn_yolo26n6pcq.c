...
vsi_nn_graph_t * vnn_CreateYolo26n6Pcq
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.04450204223394394;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.04653006047010422;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.05769844725728035;
    attr.dtype.zero_point = -128;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.10247597098350525;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.1125277727842331;
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.3198716938495636;
...
error:
    ...
    vnn_ReleaseYolo26n6Pcq( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateYolo26n6Pcq() */

void vnn_ReleaseYolo26n6Pcq
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )

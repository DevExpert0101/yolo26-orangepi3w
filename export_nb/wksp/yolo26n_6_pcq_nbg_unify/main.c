...
{
    vnn_ReleaseYolo26n6Pcq( graph, TRUE );
...
{
    return vnn_PostProcessYolo26n6Pcq( graph );
}
    ...
    )
{
    ...
    return vnn_PreProcessYolo26n6Pcq( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateYolo26n6Pcq( data_file_name, NULL,

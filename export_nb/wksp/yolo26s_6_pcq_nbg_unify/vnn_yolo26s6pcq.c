...
vsi_nn_graph_t * vnn_CreateYolo26s6Pcq
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.16330201923847198;
    attr.dtype.zero_point = 118;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_NORM_TENSOR(norm_tensor[4], attr, VSI_NN_TYPE_INT8);

    /* @attach_cls_p5/out0_5:out0 */
    memset( &attr, 0, sizeof( attr ) );
    attr.size[0] = 20;
    attr.size[1] = 20;
    attr.size[2] = 80;
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.scale = 0.17698483169078827;
    attr.dtype.zero_point = 112;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_NORM_TENSOR(norm_tensor[5], attr, VSI_NN_TYPE_INT8);
    ...
    attr.dtype.zero_point = -128;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_NORM_TENSOR(norm_tensor[6], attr, VSI_NN_TYPE_INT8);
...
error:
    ...
    vnn_ReleaseYolo26s6Pcq( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateYolo26s6Pcq() */

void vnn_ReleaseYolo26s6Pcq
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
